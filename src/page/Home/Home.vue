	...
	<div class="box">
      <div id='arr_1'>
        ...
        <div class="arr_3">
          ...
          <van-swipe :autoplay="3000" indicator-color="white" style='margin-top:1.1rem;height:3.1rem;width:100%'>
  			 <van-swipe-item v-for="(item, index) in arr" :key="index"><img :src='item.img' alt='' style='height: 3.1rem;width:100%'/></van-swipe-item>
        </van-swipe>
        <nav>
...
.arr_2{
	...
	margin:0.2rem 0 0 0.3rem;float:left;
}
.arr_3{
	width:3.3rem;height:0.47rem;background:#fff;float:right;
	margin:0.35rem 0.43rem 0 0;border-radius: 0.47rem 0.6rem 0.47rem 0.47rem;
}
input{
	width:2.5rem;
	float: right;margin:0.08rem 0.1rem 0 0;border:none;
}
.arr_4{
	width:0.3rem;height:0.3rem;float: left;
	margin-top: 0.08rem;margin-left: 0.2rem;
}
ul{
...
.san{
	color:#EA625B;font-weight: bold;font-size: 0.22rem;
}
</style>